...
const ConferencePage5 = () => {
  return (
    <Wrapper>
      <Navibar />
      <FestivalWrap>
        <img src={festival1} alt='서울테크밋업' className='bg' />
        <PaddingWrap>
...
export default ConferencePage5;

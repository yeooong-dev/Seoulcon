  ...
  return (
    <Wrapper>
      ...
      <FestivalWrap>
        <img
          src={festival1}
          alt='크리에이터 글로벌 진출 솔루션 세미나'
          className='bg'
        />
        <PaddingWrap>
          <img src={Triangle} alt='도형' className='Triangle' />
          <Title>크리에이터 글로벌 진출 솔루션 세미나</Title>
          <Divider />
          <Contents>
            <div className='right'>
              <div>
            ...
            <div className='left'>
              ...
              <p>• 23. 12. 31.(일) 14:00 ~ 18:00</p>
              <p className='date'>장소</p>
              <p>• DDP 디자인랩 3층 디자인홀</p>
              <p className='date'>내용</p>
              <p>
                • 크리에이터가 꿈이거나 현직 크리에이터를 위한 공간
                <br />• 크리에이터를 위한 글로벌 진출 지원
              </p>
...
export default ConferencePage4;
